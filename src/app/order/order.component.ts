...
export class OrderComponent implements OnInit {
  ...
  constructor(private navigationService: NavigationService, public utilityService: UtilityService, private router: Router) { }
  ...
  placeOrder() {
    ...
    let count = timer(0, 2000).subscribe((res) => {
      ...
      if (step == 4) {
        confirm('Get your Invoice in PreviousCart!');
